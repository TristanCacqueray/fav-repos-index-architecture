              ...
              Hs.Just x ->
                case x of
                  RegisterResponseValueRepo y ->
                    ( HsProtobuf.encodeMessageField
                        (HsProtobuf.FieldNumber 1)
                        ( Hs.coerce @(Hs.Maybe Fri.Messages.Repo)
                            @(HsProtobuf.Nested Fri.Messages.Repo)
                            (Hs.Just y)
                        )
                    )
      ...
      <*> ( HsProtobuf.oneof
              ...
              [ ( (HsProtobuf.FieldNumber 1),
                  (Hs.pure (Hs.fmap RegisterResponseValueRepo))
                    <*> ( Hs.coerce @(_ (HsProtobuf.Nested Fri.Messages.Repo))
                            @(_ (Hs.Maybe Fri.Messages.Repo))
                            HsProtobuf.decodeMessageField
                        )
                ),
                ( (HsProtobuf.FieldNumber 2),
...
data RegisterResponseValue
  = RegisterResponseValueRepo Fri.Messages.Repo
...
data SearchResponse = SearchResponse
  { searchResponseScore ::
      Hs.Int32,
    searchResponseRepo :: Hs.Maybe Fri.Messages.Repo
  }
  deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic, Hs.NFData)
